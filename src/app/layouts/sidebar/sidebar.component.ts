...
export class SidebarComponent {
  ...
  currentUser =  this.tokenStoreageService.getUser();
  getCompany = this.tokenStoreageService.getCompany()

  constructor(private router: Router, public translate: TranslateService,private tokenStoreageService: TokenStorageService,
    private isMenu:MenuClass, private authService: AuthenticationService
    ) {
  ...
  ngOnInit(): void {
    ...
    // const getItem =  localStorage.getItem('currentUser');

    // if(getItem && getItem.length > 0){
    // const getName =  JSON?.parse(getItem);
    // this.menuItems = getName.email === 'admin'? getAdmin: getUser;
    // }else{
    //   return
    // }
