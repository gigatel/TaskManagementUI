...
export class MenuClass {
    ...
    if (
      ...
      for (let i = 0; i < this.menu.length; i++) {
        for (let j = 0; j < this.menu[i]?.subItems?.length; j++) {
          ...
          //   if (this.menu[i].subItems[j].subItems == undefined || this.menu[i].subItems[j]?.subItems?.length == 0) {
          //     if (this.menu[i].subItems[j].policyName == "NoPolicyCheck" || this.tokenStorageService.checkPolicies(this.menu[i].subItems[j].policyName)) {
          //       if (menu.filter(x => x.label == this.menu[i].label && x.role === currentUser.role).length == 0) {
          //         let header = JSON.parse(JSON.stringify(this.menu[i]));
          //         header.subItems = [];
          //         menu.push(header)
          //       }
          //       var header = menu.filter(x => x.label == this.menu[i].label)[0];
          //       if (header.subItems.filter((x: any) => x.label == this.menu[i].subItems[j].label && x.role === currentUser.role).length == 0) {
          ...
          //   }
          // }
          // if (this.menu[i].subItems == undefined || this.menu[i]?.subItems?.length == 0) {
          //   var policy: any = this.menu[i].policyName;
          //   if (policy != null && (policy == "NoPolicyCheck" || this.tokenStorageService.checkPolicies(policy))) {
          //     // const filtered = menu.filter(x => {
          //     //   return  x.label == this.menu[i].label && this.menu[i].role === 'admin';
          //     // })
          ...
          //     //   let header = JSON.parse(JSON.stringify(filtered));
          //     //     header.subItems = [];
          //     //     menu.push(header)
          //     // }
          //   }
  ...
  callMenu() {
    this.menu = [
      ...
      //             link: '/page/dashboard/crm',
      //             parentId: 2
      //         },
      //         {
      //             id: 5,
      //             label: 'MENUITEMS.DASHBOARD.LIST.ECOMMERCE',
      //             link: '/page/dashboard/ecommerce',
      //             parentId: 2
      //         },
      //         {
      //             id: 6,
      //             label: 'MENUITEMS.DASHBOARD.LIST.LEARNING',
      //             link: '/page/dashboard/learning',
      //             parentId: 2
      //         },
      //         {
      //             id: 7,
      //             label: 'MENUITEMS.DASHBOARD.LIST.REALESTATE',
      //             link: '/page/dashboard/real-estate',
      //             parentId: 2
      //         }
      //     ]
      // },
      ...
      // {
      //     id: 61,
      //     label: 'MENUITEMS.policyName.TEXT',
      //     icon: 'ph-user-circle',
      //     subItems: [
      //         {
      //             id: 62,
      //             label: 'MENUITEMS.policyName.LIST.SIGNIN',
      //             link: '/auth/signin',
      //             parentId: 61,
      //         },
      //         {
      //             id: 63,
      //             label: 'MENUITEMS.policyName.LIST.SIGNUP',
      //             link: '/auth/signup',
      //             parentId: 61,
      //         },
      //         {
      //             id: 64,
      //             label: 'MENUITEMS.policyName.LIST.PASSWORDRESET',
      //             link: '/auth/pass-reset',
      //             parentId: 61,
      //         },
      //         {
      //             id: 65,
      //             label: 'MENUITEMS.policyName.LIST.PASSWORDCREATE',
      //             link: '/auth/pass-change',
      //             parentId: 61,
      //         },
      //         {
      //             id: 66,
      //             label: 'MENUITEMS.policyName.LIST.LOCKSCREEN',
      //             link: '/auth/lockscreen',
      //             parentId: 61
      //         },
      //         {
      //             id: 67,
      //             label: 'MENUITEMS.policyName.LIST.LOGOUT',
      //             link: '/auth/logout',
      //             parentId: 61
      //         },
      //         {
      //             id: 68,
      //             label: 'MENUITEMS.policyName.LIST.SUCCESSMESSAGE',
      //             link: '/auth/success-msg',
      //             parentId: 61
      //         },
      //         {
      //             id: 69,
      //             label: 'MENUITEMS.policyName.LIST.TWOSTEPVERIFICATION',
      //             link: '/auth/twostep',
      //             parentId: 61
      //         },
      //         {
      //             id: 70,
      //             label: 'MENUITEMS.policyName.LIST.ERRORS',
      //             parentId: 61,
      //             subItems: [
      //                 {
      //                     id: 71,
      //                     label: 'MENUITEMS.policyName.LIST.404ERROR',
      //                     link: '/auth/errors/404',
      //                     parentId: 70
      //                 },
      //                 {
      //                     id: 72,
      //                     label: 'MENUITEMS.policyName.LIST.500',
      //                     link: '/auth/errors/500',
      //                     parentId: 70
      //                 },
      //                 {
      //                     id: 73,
      //                     label: 'MENUITEMS.policyName.LIST.503',
      //                     link: '/auth/errors/503',
      //                     parentId: 70
      //                 },
      //                 {
      //                     id: 74,
      //                     label: 'MENUITEMS.policyName.LIST.OFFLINE',
      ...
      //             link: '/page/ui/accordion',
      //             parentId: 88
      //         },
      // {
      //     id: 100,
      //     label: 'MENUITEMS.BOOTSTRAPUI.LIST.MODALS',
      //     link: '/admin/page/ui/modal',
      //     parentId: 88
      // },
      //         {
      //             id: 102,
      ...
      //             link: '/page/tables/basic',
      //             parentId: 138
      //         },
      //         {
      //             id: 140,
      //             label: 'MENUITEMS.TABLES.LIST.GRIDJS',
      //             link: '/page/tables/gridjs',
      //             parentId: 138
      //         },
      //         {
      //             id: 141,
      //             label: 'MENUITEMS.TABLES.LIST.LISTJS',
      //             link: '/page/tables/listjs',
      //             parentId: 138
      //         }
      //     ]
      // },
      ...
      //             link: '/page/icons/remix',
      //             parentId: 159
      //         },
      //         {
      //             id: 161,
      //             label: 'MENUITEMS.ICONS.LIST.BOXICONS',
      //             link: '/page/icons/boxicons',
      //             parentId: 159
      //         },
      //         {
      //             id: 162,
